...
import { closeDbPool, getDbPool } from "../src/db.js";

async function resetTables(): Promise<void> {
  const pool = getDbPool();
  await pool.query("DELETE FROM etf_positions");
  await pool.query("DELETE FROM etf_portfolios");
  await pool.query("DELETE FROM etf_orders");
}
