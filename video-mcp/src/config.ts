...
import { DEFAULT_DASHSCOPE_BASE_URL, DEFAULT_MODEL, type VideoProviderConfig } from "./types.js";
...
export function resolveVideoConfig(source: EnvSource = process.env): VideoProviderConfig {
