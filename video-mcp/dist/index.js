...
server.tool("generate_video_from_frames", "基于首帧图和尾帧图生成无声视频（DashScope）。自动根据模型切换 wan2.7 i2v 与 legacy kf2v 接口，并轮询直到任务完成。", {
...
server.tool("generate_video_from_first_frame", "基于首帧图生成视频（DashScope wan2.7/happyhorse i2v）。自动轮询直到任务完成。", {
    first_frame_url: z.string().min(1).describe("首帧图像 URL、oss:// URL、本地 file:// 路径或 data:image/... base64。"),
    ...commonSchema
}, async (input) => {
    try {
