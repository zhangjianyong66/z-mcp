...
server.tool(
  "generate_lyrics",
  "Generate song lyrics from a text prompt via MiniMax lyrics_generation API.",
  {
...
server.tool(
  "generate_music",
  "Generate music from prompt/lyrics via MiniMax music_generation API.",
  {
...
server.tool(
  ...
  "End-to-end workflow: generate lyrics first, then generate music from those lyrics.",
  {
    prompt: z.string().min(1),
